...
export default function Home({ params: {slug}}: IParams) {
    ...
    const submitData = async () => {
        const response = await fetch(`https://bootcamp-project-2023-git-main-jojayamas-projects.vercel.app/api/blog/${slug}/comment`, {
        method: 'POST',
        headers: {
    ...
    useEffect(() => {
        const fetchBlogData = async () => {
          const response = await fetch(`https://bootcamp-project-2023-git-main-jojayamas-projects.vercel.app/api/blog/${slug}`);
